/*!
 * Drawing weather logos
 */
function drawingSun() {
    var c = document.getElementById("weather-logo");
...
$(function () {
    var locale = 'ua',
		...
		scroller = $('#scroller'),
		location = $('p.location'),
        regionInform = $('region-information'),
        counrtyInform = $('country-information');
    ...
    function dataReceived(data) {
        ...
        regionInform.html(city);
        counrtyInform.html(country);
